<template>
  <div class="hello" data-demo-id="flowchart">
    <button @click="toGroup">to group</button>
    <button @click="toExample">to example</button>
    <button @click="toTest">to test</button>
    <button @click="toVueTest">to vuetest</button>
